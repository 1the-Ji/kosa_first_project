<%@ page contentType="text/html;charset=UTF-8" %>
 ...
 <div id="mgroupDigertModal" class="modal fade" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document">
     <div class="modal-content">
       <div class="modal-header">
         <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
         <h4 class="modal-title"><b>주문 1차 화면&디저트 메뉴 화면</b></h4>
       </div>
       <div class="modal-body">
         ...
         <table id="acrylic">
             ...
             <tbody>
             	...
             	<%--테스트 데이터 --%>
             		<tr>
                     	<td data-label="메뉴번호">디저트메뉴1</td>
                     	<td data-label="메뉴사진">디저트사진1</td>
                     	<td class="orderForm2" data-label="메뉴이름"><a type="button" class="btn btn-primary" href="#">크림케이크</a></td>
                 	</tr>
                 	<tr>
                     	<td data-label="메뉴번호">디저트번호2</td>
                     	<td data-label="메뉴사진">디저트사진2</td>
                     	<td class="orderForm2" data-label="메뉴이름"><a  type="button" class="btn btn-primary" href="#">치즈케이크</a></td>
                 	</tr>
